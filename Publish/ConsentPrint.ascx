...
<ul class="content">
    <li>
        ...
        <div class="right">
            The physician has explained to me the nature of this operation and how it is generally
            carried out. I understand that all procedures surgeries involve general risks such
            as severe loss of blood, infection, heart stoppage or death. The physician has discussed
            with me the specific risks, benefits and possible side effects of this procedure
    ...
    <li>
        ...
        <div class="right">
            ...
            to the taking and publication of photographs or video taping in the course of the
            operation; and to the admittance of observers to the Operating Room for the purpose
    ...
    <li>
        ...
        <div class="right">
            I permit and authorize the physician and such other physicians or qualifeid medical
