<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SurgicalConsentPrintV2.aspx.cs" Inherits="WindowsCEConsentForms.SurgicalConsentPrintV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul class="content print">
        ...
        <li>I here by authorize Doctor(s) 
            ...
            the following procedure or operation <br /> 
    ...
    <ul class="content print">
        ...
        <li>
            <label>
                Pt. is unable to sign because </label>
        </li>
        <li>
            <asp:Label runat="server" ID="LblReason" CssClass="errorInfo"></asp:Label>            
        </li>
        <li>
            <label>If patient is unable to sign/Person Authorized to sign consent/Relationship to patient</label>
        </li>
        <li>
            <div class="sigBox">
        ...
        <li><label>Patient Signature</label></li>
        <li><div class="sigBox">
        ...
        <li>
            <label>Translated by (name & empl.#)</label>
        </li>
        <li>
            <div class="sigBox">
        ...
        <li>
            <label>Witness to signature only</label>
        </li>
        <li>
            <div class="sigBox">
        ...
        <li>
            <label>I decalre that I or my associate Dr.</label>
        </li>
        <li>
            <div class="sigBox">
        ...
        <li>
            <label>personally explained the above information to the patient or the patients's representative</label>
        </li>
    </ul>
    </form>
</asp:Content>
