...
{
    public partial class OutsideORConsent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!isItNewSession)
                {
                    ...
                    ViewState["Signature1"] = formHandlerServiceClient.GetPatientSignature(patientId, "OutsideORConsent",
                                                                                           "signature1");
                    ViewState["Signature2"] = formHandlerServiceClient.GetPatientSignature(patientId, "OutsideORConsent",
                                                                                           "signature2");
                    ViewState["Signature3"] = formHandlerServiceClient.GetPatientSignature(patientId, "OutsideORConsent",
                                                                                           "signature3");
                    ViewState["Signature4"] = formHandlerServiceClient.GetPatientSignature(patientId, "OutsideORConsent",
                                                                                           "signature4");
                    ViewState["Signature5"] = formHandlerServiceClient.GetPatientSignature(patientId, "OutsideORConsent",
                                                                                           "signature5");
                }
            }
            catch (Exception)
        ...
        protected void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool result = formHandlerServiceClient.SavePatientSignature(patientId, Encoding.ASCII.GetString(bytes), "OutsideORConsent", "signature1");

                // updating signature2
                bytes = Encoding.ASCII.GetBytes(Request.Form["HdnImage2"]);
                result = formHandlerServiceClient.SavePatientSignature(patientId, Encoding.ASCII.GetString(bytes), "OutsideORConsent", "signature2");

                // updating signature3
                bytes = Encoding.ASCII.GetBytes(Request.Form["HdnImage3"]);
                result = formHandlerServiceClient.SavePatientSignature(patientId, Encoding.ASCII.GetString(bytes), "OutsideORConsent", "signature3");
                ...
                Response.Redirect("/OutsideORConsentDeclaration.aspx");
            }
            catch (Exception)
            {
                return;
