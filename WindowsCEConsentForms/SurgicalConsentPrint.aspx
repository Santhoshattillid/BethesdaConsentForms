 ...
 <form id="form1" runat="server">
    <ul class="content">
        ...
        <li>I here by authorize Doctor(s) 
            <asp:Label runat="server" ID="LblAuthoriseDoctors"></asp:Label>
        </li>
        <li>
            to perform upon
            <asp:Label runat="server" ID="LnlPatientName" CssClass="errorInfo"></asp:Label>
            the following procedure or operation <br /> <asp:Label runat="server" ID="LblProcedureName"></asp:Label></li>
        <li>
            <div class="sigBox">
        ...
        <li>
            <div class="right">
                Pt. is unable to sign because: <asp:Label runat="server" ID="LblReason"></asp:Label>
            </div>
            <div class="right">
        ...
        <li>
            I declare that I or my associate, Dr. <asp:Label runat="server" ID="LblPrimaryDoctor"></asp:Label> , personally explained   the above information to the patient or the patient's representative.                                                                      
        </li>
    </ul>
    </form>
</asp:Content>
