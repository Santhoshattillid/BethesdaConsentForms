<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BloodConsentOrRefusalDeclaration.aspx.cs" Inherits="WindowsCEConsentForms.SurgicalConsentDeclaration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <ul>
            <li>
                <h3>
                    Blood Consent Or Refusal Form</h3>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    ...
                    the following procedure or operation : Blood Consent Or Refusal
                </p>
            </li>
            <li>
                <p>
