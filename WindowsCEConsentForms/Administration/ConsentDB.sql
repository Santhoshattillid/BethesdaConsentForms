USE [master]
GO
/****** Object:  Database [eConsentum]    Script Date: 01/03/2013 09:06:26 ******/

ALTER DATABASE [eConsentum] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [eConsentum].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [eConsentum] SET ANSI_NULL_DEFAULT OFF
GO
ALTER DATABASE [eConsentum] SET ANSI_NULLS OFF
GO
ALTER DATABASE [eConsentum] SET ANSI_PADDING OFF
GO
ALTER DATABASE [eConsentum] SET ANSI_WARNINGS OFF
GO
ALTER DATABASE [eConsentum] SET ARITHABORT OFF
GO
ALTER DATABASE [eConsentum] SET AUTO_CLOSE OFF
GO
ALTER DATABASE [eConsentum] SET AUTO_CREATE_STATISTICS ON
GO
ALTER DATABASE [eConsentum] SET AUTO_SHRINK OFF
GO
ALTER DATABASE [eConsentum] SET AUTO_UPDATE_STATISTICS ON
GO
ALTER DATABASE [eConsentum] SET CURSOR_CLOSE_ON_COMMIT OFF
GO
ALTER DATABASE [eConsentum] SET CURSOR_DEFAULT  GLOBAL
GO
ALTER DATABASE [eConsentum] SET CONCAT_NULL_YIELDS_NULL OFF
GO
ALTER DATABASE [eConsentum] SET NUMERIC_ROUNDABORT OFF
GO
ALTER DATABASE [eConsentum] SET QUOTED_IDENTIFIER OFF
GO
ALTER DATABASE [eConsentum] SET RECURSIVE_TRIGGERS OFF
GO
ALTER DATABASE [eConsentum] SET  DISABLE_BROKER
GO
ALTER DATABASE [eConsentum] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
GO
ALTER DATABASE [eConsentum] SET DATE_CORRELATION_OPTIMIZATION OFF
GO
ALTER DATABASE [eConsentum] SET TRUSTWORTHY OFF
GO
ALTER DATABASE [eConsentum] SET ALLOW_SNAPSHOT_ISOLATION OFF
GO
ALTER DATABASE [eConsentum] SET PARAMETERIZATION SIMPLE
GO
ALTER DATABASE [eConsentum] SET READ_COMMITTED_SNAPSHOT OFF
GO
ALTER DATABASE [eConsentum] SET HONOR_BROKER_PRIORITY OFF
GO
ALTER DATABASE [eConsentum] SET  READ_WRITE
GO
ALTER DATABASE [eConsentum] SET RECOVERY SIMPLE
GO
ALTER DATABASE [eConsentum] SET  MULTI_USER
GO
ALTER DATABASE [eConsentum] SET PAGE_VERIFY CHECKSUM
GO
ALTER DATABASE [eConsentum] SET DB_CHAINING OFF
GO
USE [eConsentum]
GO
