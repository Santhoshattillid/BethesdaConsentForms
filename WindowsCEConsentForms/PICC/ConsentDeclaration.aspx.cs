        ...
        protected void BtnCompleted_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.Form["HdnImage1"] != null)
                {
                    ...
                    var result = formHandlerServiceClient.SavePatientSignature(patientId, Encoding.ASCII.GetString(bytes), "PICCConsent", "signature7");
                }
                ...
                if (Request.Form["HdnImage2"] != null)
                {
                    ...
                    var result = formHandlerServiceClient.SavePatientSignature(patientId, ASCIIEncoding.ASCII.GetString(bytes), "PICCConsent", "signature8");
                }
                ...
                if (Request.Form["HdnImage3"] != null)
                {
                    ...
                    var result = formHandlerServiceClient.SavePatientSignature(patientId, ASCIIEncoding.ASCII.GetString(bytes), "PICCConsent", "signature9");
                }
                ...
                if (Request.Form["HdnImage4"] != null)
                {
                    ...
                    var result = formHandlerServiceClient.SavePatientSignature(patientId, ASCIIEncoding.ASCII.GetString(bytes), "PICCConsent", "signature10");
                }
                ...
                if (Request.Form["HdnImage5"] != null)
                {
                    ...
                    var result = formHandlerServiceClient.SavePatientSignature(patientId, ASCIIEncoding.ASCII.GetString(bytes), "PICCConsent", "signature11");
                }
                ...
                */
                ...
                formHandlerServiceClient.GenerateAndUploadPDFtoSharePoint("http://devsp1.atbapps.com:5555/PICCConsentPrintV1.aspx?PatientId=" + patientId, patientId, "PICCConsentForm1");
