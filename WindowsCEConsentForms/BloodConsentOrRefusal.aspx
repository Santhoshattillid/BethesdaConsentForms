<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BloodConsentOrRefusal.aspx.cs" Inherits="WindowsCEConsentForms.BloodConsentOrRefusal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <ul>
            <li>
                <h3>
                    Blood Consent / Refusal Consent Form</h3>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    ...
                    the following procedure or operation : Blood Consent / Refusal Consent
                </p>
            </li>
            <li>
